...
class HeartbeatStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendHeartbeat = channel.unary_unary(
                '/heartbeat.Heartbeat/SendHeartbeat',
                request_serializer=heartbeat__pb2.HeartbeatRequest.SerializeToString,
                response_deserializer=heartbeat__pb2.EmptyResponse.FromString,
...
def add_HeartbeatServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendHeartbeat': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=heartbeat__pb2.EmptyResponse.SerializeToString,
            ),
    }
...
class Heartbeat(object):
    ...
    def SendHeartbeat(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            heartbeat__pb2.EmptyResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
