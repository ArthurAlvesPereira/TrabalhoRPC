...
# Configs para terminal 2
TERMINAL_ID = "terminal_2"
TERMINAL_PORT = "50152"
MY_PRIMARY_MANAGED_CLASSES = ["Intermediarios", "SUV"]
FLEET = {
    "Intermediarios": [
        {"name": "Honda City", "available": True, "rented_to_client_id": None},
        {"name": "Fiat Cronos", "available": True, "rented_to_client_id": None},
        {"name": "Volkswagen Virtus", "available": True, "rented_to_client_id": None},
    ],
    "SUV": [
        {"name": "Jeep Commander", "available": True, "rented_to_client_id": None},
        {"name": "Audi Q7", "available": True, "rented_to_client_id": None},
        {"name": "Lexus RX", "available": True, "rented_to_client_id": None},
    ]
}
